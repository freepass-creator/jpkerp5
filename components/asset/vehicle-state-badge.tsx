...
/** 차량 + 계약목록으로 자동 해석 */
export function VehicleStateBadge({ vehicle, contracts }: { vehicle: Pick<Vehicle, 'status' | 'plate'>; contracts: readonly Contract[] }) {
  const s = resolveVehicleState(vehicle, contracts);
  return (
