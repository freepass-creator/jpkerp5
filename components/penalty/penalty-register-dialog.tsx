  ...
  const ocr = useOcrBatch<WorkItem>({
    ...
    applyResult: (prev, raw) => {
      ...
      return {
        ...
        surcharge_amount: typeof raw.surcharge_amount === 'number' ? raw.surcharge_amount : 0,
        toll_amount: typeof raw.toll_amount === 'number' ? raw.toll_amount : 0,
        demerit_points: typeof raw.demerit_points === 'number' ? raw.demerit_points : 0,
        payer_name: (raw.payer_name as string) ?? '',
        opinion_period: (raw.opinion_period as string) ?? '',
