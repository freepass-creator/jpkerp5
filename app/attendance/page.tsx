 ...
 * 근태 결재 — 데스크탑.
 *
 * 모바일(/m/me/attendance)에서 들어온 신청을 사무에서 승인/반려.
 * 향후 다단계 전자결재 / 다른 결재 종류 (비용/출장 등) 확장 시 라우트 확장.
 */
      ...
      <div className="app">
        <header className="topbar">
          <div className="topbar-title">
            ...
            <span style={{ color: 'var(--text-main)', fontWeight: 600 }}>휴가·반차·조퇴 신청</span>
          </div>
        </header>
