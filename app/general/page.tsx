        ...
        {companies.length === 0 ? (
          ...
          return (
            ...
            >
              ...
              <td className="dim" style={{ letterSpacing: '-0.04em' }}>{c.corpRegNo || '-'}</td>
              <td className="dim" style={{ letterSpacing: '-0.04em' }}>{c.bizRegNo || '-'}</td>
              ...
              <td className="dim" style={{ letterSpacing: '-0.04em' }}>{c.contactPhone || '-'}</td>
