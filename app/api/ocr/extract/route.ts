...
const PENALTY_SCHEMA = {
  ...
  properties: {
    ...
    toll_amount: { type: Type.INTEGER, nullable: true, description: '통행료 원금(원) — 통행료 미납 고지 시' },
    demerit_points: { type: Type.INTEGER, nullable: true, description: '벌점(점) — 운전자 통보 대상. 없으면 null' },
    payer_name: { type: Type.STRING, nullable: true, description: '명의자(피고지자) 성명/법인명' },
    opinion_period: { type: Type.STRING, nullable: true, description: '의견제출/진술 기간 (예: 2026-05-30 까지)' },
